...
$(document).ready(function () {
    ...
    $("#clearMachineCode").on('click', function(){$("#machineCode").html('')});
    ...
    function step(){
        ...
        try{
            ...
            assembledLine = me.getAssembledLine(lastLineAttempted);
            addToMachineCodeLog(assembledLine, lastLineAttempted);
            lineResult = me.step();
            if(lineResult){
    ...
    function addToMachineCodeLog(assembledLine, line_no)
    {
        assembledLine = assembledLine.replace(/\n/g, "<br />");
        //console.log("This is the assembledLine in main.js ln 470: ", assembledLine);
        if(line_no){
            assembledLine = assembledLine.slice(0,35);
            assembledLine = "Line " + line_no + ": " + assembledLine;
        }
        $("#machineCode").append(
            '<div>'+assembledLine+'</div>'
        );
    }
});
